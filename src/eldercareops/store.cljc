(ns eldercareops.store
  "SSoT for the ISIC-873 residential-care COORDINATION actor,
  ...
  facility for elderly and disabled residents: daily care-note logging,
  family visit scheduling, consumable supply coordination, staff shift
  proposals, and safety-concern flagging (falls, wellbeing incidents).
  It never touches medication administration, clinical diagnosis/assessment,
  care-plan modifications, physical restraint decisions, end-of-life/DNR
  decisions, or any safety-authority override -- see `eldercareops.governor`'s
  ...
  for that resident may ever commit or escalate -- `eldercareops.governor`'s
