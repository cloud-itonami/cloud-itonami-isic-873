# Operator Quickstart — Residential Care Activities for the Elderly and Disabled

Shortest path from clone to a verified local dry-run for **ISIC 873** (`cloud-itonami-isic-873`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-873.git
cd cloud-itonami-isic-873
```
...
- Blueprint governor key: `eldercare-governor`
- Likely source path: `eldercareops.governor.cljc`
